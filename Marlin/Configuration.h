...
#define Z_HEIGHT_MM 215.2  // set to feasible max, but need to measure & set z home offset manually using bed levelling 
...
#define STRING_CONFIG_H_AUTHOR "(CR, Mendel90 SKR 1.3 16.03.2022)" // Who made the changes.
